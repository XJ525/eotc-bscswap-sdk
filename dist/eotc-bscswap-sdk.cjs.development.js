...
(function (ChainId) {
  ...
  ChainId[ChainId["BSC_TSET"] = 97] = "BSC_TSET";
  ChainId[ChainId["OKEXCHAIN"] = 66] = "OKEXCHAIN";
  ChainId[ChainId["HUOBI"] = 128] = "HUOBI";
...
})(exports.Rounding || (exports.Rounding = {})); //swap的工厂合约地址


var FACTORY_ADDRESS = '0x73857Fa9a849Cd6DC8387C37f54Ad0F56B575eA2'; //初始化代码哈希

var INIT_CODE_HASH = '0xa9fbfced95fed0f4cbe56a6f056f7f895c31bee594b6a273f043d2ae917102e3';
...
var Currency = /*#__PURE__*/function () {
  ...
  Currency.setETHER = function setETHER(decimals, symbol, name) {
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === Currency.ETHER && pairs[0].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === Currency.ETHER && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === Currency.ETHER ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === Currency.ETHER ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency === Currency.ETHER;
    var etherOut = trade.outputAmount.currency === Currency.ETHER; // the router does not support both ether in and out
...
//# sourceMappingURL=eotc-bscswap-sdk.cjs.development.js.map
